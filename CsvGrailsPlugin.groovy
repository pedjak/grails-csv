...
class CsvGrailsPlugin {
    ...
    def description = '''
        ...
        supports complex parsing rules such as nested commas inside quotes (escaped tokens), multi-line quoted values
        and allows configuration of parsing options (separator char, escape char, text encoding, etc).  It is based on
        Glen Smith (et. al.)'s OpenCSV project (http://opencsv.sourceforge.net)
